...
class CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(16, 32, 5, stride=2, padding=2)#None # convolutional layer 2
        self.conv3 = nn.Conv2d(32, 64, 5, stride=2, padding=2)#None # convolutional layer 3
        self.conv4 = nn.Conv2d(64, 128, 5, stride=2, padding=2)#None # convolutional layer 4
        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(512,64)#None   # fully connected layer 1
        self.fc2 =  nn.Linear(64,5)#None  # fully connected layer 2 (output layer)
    ...
    def init_weights(self):
        ...
        for conv in [self.fc1, self.fc2]:   
            C_in_f = conv.weight.size(1)
            nn.init.normal_(conv.weight, 0.0, 1/math.sqrt(C_in_f/2))
            nn.init.constant_(conv.bias, 0.0)
